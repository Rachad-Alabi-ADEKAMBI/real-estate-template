...
<head>
    ...
    <title>Fares Immobilier - Inscription</title>
</head>
            ...
            <h1 class="form__title">
                Inscription
                 ...
                 <div class="form__name">
                    <label for="" class="form__name__firstname" >
                        Prénom: <br>
                        <input type="text" name="first_name"required>
                    </label>

                    <label for="last_name" class="form__name__lastname">
                        Nom: <br>
                ...
                <label for="email" class="email">
                    ...
                    <div class="form__phone">
                         ...
                         <label for="form__phone_number" class="form__phone__number" >
                             Numéro mobile: <br>
