...
<head>
    ...
    <title>Fineblock - Mes achats</title>
</head>
<body>
...
echo "<table border='1' class='history_table' >";
                     echo"<tr><td>Date</td>
                         ...
                         <td>Equivalent en PF</td><td>Nom du vendeur</td></tr>\n";
...
<?php
           ...
           <!-- <ul class="pagination " style="display: inline;     " >
                            <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?> ">
                                <a href="mes-achats.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                            </li>
                            
                            <?php   for ($page = 1; $page <= $pages; $page++): ?>

                                <li class="page-item <?= ($currentPage == $page) ? "active": "" ?> ">
                                    <a href="mes-achats.php?page=<?= $page ?>" class="page-link"> <?= $page ?></a>
                                </li>
                        
                            <?php endfor ?>
                            <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?> ">
                                <a href="mes-achats.php?page=<?= $currentPage + 1 ?>"  class="page-link">Suivante</a>
                            </li>
                        </ul> -->
        </div>
    </div>
