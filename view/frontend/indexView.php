...
$title = 'Fares Immobilier - Accueil'; 
        ...
        <div class="heading__search">
            ...
            <div class="heading__search__bar">
                <form action="" method="POST">
                    ...
                    <select name="" id="" placeholder="Selectionner le type" ></select>
                    <select name="" id="" placeholder="Selectionner la localité" ></select>
                    <div class="filtre">

                    </div>
                    <div class="input">
                        <input type="submit" value="Rehercher">
                        </div>
                </form>
            </div>
      ...
      <section id="" class=" mt-5 mb-5" >
		<div class="container">
			<div class="row about-section">
                ...
                src="https://www.youtube.com/embed/C_rS7HVgKoM" 
			...
			<div class="row about-section">
				<div class="col-lg-12 col-md-12 agents  ">
                        ...
                        <p class="agents__subtitle subtitle">
                            Accéder aux annonces de nos vendeurs certifiés
                        </p>
